...
class FXMLLoader1 {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    return aValue;
                        ...
                        if (aValue.charAt(0) == '/') {
                            ...
                            try {
                                return new URL(FXMLLoader1.this.location, aValue).toString();
                            } catch (MalformedURLException e) {
                                System.err.println(FXMLLoader1.this.location + "/" + aValue);
                            }
                        }
                }
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = FXMLLoader1.this.resources;
        public Charset charset = FXMLLoader1.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            FXMLLoader1.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (FXMLLoader1.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(FXMLLoader1.this.location, source);
            }

            FXMLLoader1 fxmlLoader = new FXMLLoader1(location, resources,
                builderFactory, controllerFactory, charset,
                loaders);
            fxmlLoader.parentLoader = FXMLLoader1.this;

            if (isCyclic(FXMLLoader1.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                        "Including \"%s\" in \"%s\" created cyclic reference.",
                        fxmlLoader.location.toExternalForm(),
                        FXMLLoader1.this.location.toExternalForm()));
            }
            ...
            if (fx_id != null) {
                ...
                if (FXMLLoader1.this.controller != null) {
                    Field field = controllerAccessor.getControllerFields()
                                                    .get(id);

                    if (field != null) {
                        try {
                            field.set(FXMLLoader1.this.controller, controller);
                        } catch (IllegalAccessException exception) {
                            throw constructLoadException(exception);
                        }
                    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader1(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader1(URL location, ResourceBundle resources) {
     ...
     * @since JavaFX 2.1
     */
    public FXMLLoader1(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     * @param charset
     */
    public FXMLLoader1(Charset charset) {
    ...
    public FXMLLoader1(URL location, ResourceBundle resources, BuilderFactory builderFactory,
        Callback<Class<?>, Object> controllerFactory, Charset charset,
        LinkedList<FXMLLoader1> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FXMLLoader1) {
            FXMLLoader1 loader = (FXMLLoader1)obj;
    ...
    private String constructFXMLTrace() {
        ...
        for (FXMLLoader1 loader : loaders) {
        ...
        if (defaultClassLoader == null) {
            ...
            if (sm != null) {
                final ClassLoader callerClassLoader = (caller != null) ?
                        ...
                        null;
                if (needsClassLoaderPermissionCheck(callerClassLoader, FXMLLoader1.class.getClassLoader())) {
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        FXMLLoader1.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        FXMLLoader1 fxmlLoader =
                new FXMLLoader1(location, resources, builderFactory,
